...
export function UploadsIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
        d="M7 16a4 4 0 0 1-.5-7.97A5 5 0 0 1 16.3 9.03 3.5 3.5 0 0 1 16 16H7Z"
        stroke="currentColor"
        strokeWidth="1.6"
      />
      <path d="M12 16V10m0 0-2.5 2.5M12 10l2.5 2.5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function TeamIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <path d="M3 20c0-3 2.7-5.4 6-5.4s6 2.4 6 5.4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
      <path d="M15.5 5.5a3 3 0 0 1 0 5.8" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
      <path d="M16 14.7c2.6.5 4.5 2.5 4.5 5.3" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    </svg>
  );
}
